...
<!-- 
<link href="http://localhost/recipe/assets/css/bootstrap.css" rel="stylesheet">
<link href="http://localhost/recipe/assets/css/bootstrap.min.css" rel="stylesheet">
-->
<div class="container">

<?php echo form_open("boot/getBoots",'class="form-inline"'); ?> 
</br>
