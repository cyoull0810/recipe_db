...
*/
		...
		$document = $this->mongo_db
			...
			->where('_id', new MongoDB\BSON\ObjectId($id->{'$id'}))
			->limit(1)
	...
	public function user($id = FALSE)
	{
		...
		$this->limit(1);
		$this->where('_id', new MongoDB\BSON\ObjectId($id->{'$id'}));
	...
	public function group($id = NULL)
	{
		...
		if (isset($id))
		{
			$this->mongo_db->where('_id', new MongoDB\BSON\ObjectId($id->{'$id'}));
		}
